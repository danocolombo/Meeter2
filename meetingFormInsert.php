...
<table id="formTable">
	...
	<tr>
		<td>
                ...
                echo "</tr>";
                echo "<tr>";
                //echo "<tr><td>hoster count</td><td>" . sizeof($hoster) . "</td></tr>";
//                 foreach ($hoster as $heep){
//                     echo "<tr><td colspan=\"2\">" . print_r($heep) . "</td></tr>";
//                 }
...
//                     }
                    ...
                    echo "<tr><td>wPeeps = </td><td>" . sizeof($wPeeps) . "</td></tr>";
                    foreach ($wPeeps as $peep) {
                        echo "<tr><td colspan=\"2\">" . print_r($peep) . "</td></tr>";
